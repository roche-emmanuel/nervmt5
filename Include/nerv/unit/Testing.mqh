...
#define REQUIRE_LE(v1,v2) REQUIRE_LT_MSG(v1,v2,"Lesser or equal assertion failed: "<<(v1)<<">"<<(v2))
#define REQUIRE_GE(v1,v2) REQUIRE_GT_MSG(v1,v2,"Greater or equal assertion failed: "<<(v1)<<"<"<<(v2))
