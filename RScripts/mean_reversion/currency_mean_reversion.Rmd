...
In this analysis, we analyze the mean reversion property of pre-fabricated Forex currency pairs. We start with **USDCAD**, analyzing the daily close prices, from July 22, 2007 to March 28, 2012. This analysis is based on the original study provided in **Algoritmic trading winning strategies**.
