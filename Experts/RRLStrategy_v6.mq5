...
#include <nerv/trade/RRLEMAStrategyDry.mqh>
...
int OnInit()
{
  ...
  strategy = new nvRRLEMAStrategyDry(transCost, numInputs, trainLen, evalLen, _Symbol,_Period);
  nvRRLEMAModel* model = (nvRRLEMAModel*)strategy.getModel();
  model.setMaxIterations(maxCGIters);
